...
export function decodeDebugPacket(data: Uint8Array): DebugPacket | null {
  ...
  return {
    ...
    resetReason: data[24],
    protocolVersion: data[25],
    conversionSequence: view.getUint32(26),
    lastConversionTimestamp: view.getUint32(30),
    validSamples: data[34],
    configuredSamplesInUse: data[35],
